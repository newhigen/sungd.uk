...
ROWS = [
    ...
    (2026, 5, 'tech', '토스 AI 웨비나: Data Engineer와 Data Analytics Engineer', 'Toss AI Webinar: Data Engineers and Data Analytics Engineers', None, ''),
    (2026, 5, 'tech', '원티드 하이파이브 2026', 'Wanted HighFive 2026', 'seoul', 'https://event.wanted.co.kr/highfive/2026'),
    (2026, 4, 'tech', '토스 모닥불: 토스 FE는 AI를 이렇게 씁니다', 'Toss Modakbul: How Toss Frontend Uses AI', None, ''),
...
<div class="cv-wrap">
  ...
  <nav class="nav-top">
    <a href="{t['home']}" class="back-home">← sungd.uk</a>
    <div class="nav-right">
