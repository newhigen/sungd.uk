#!/bin/zsh
# 홈과 cv 에 쓰는 한글 글꼴(마루부리, SUIT)을 KS X 1001 한글 2,350자 + ASCII로 잘라 public/fonts 에 둔다.
...
curl -sL -o "$tmp/SUIT-SemiBold.woff2" https://cdn.jsdelivr.net/gh/sun-typeface/SUIT@2/fonts/static/woff2/SUIT-SemiBold.woff2
...
for f in MaruBuri-Regular.ttf MaruBuri-SemiBold.ttf SUIT-SemiBold.woff2 SUIT-Bold.woff2 SUIT-ExtraBold.woff2; do
